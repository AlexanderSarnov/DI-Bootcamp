...
-- ALTER TABLE items ADD COLUMN index SERIAL PRIMARY KEY,
-- 					ADD COLUMN item_name VARCHAR (255) NOT NULL,
-- 					ADD COLUMN item_price DECIMAL (10,2) NOT NULL;
...
-- ALTER TABLE customers ADD COLUMN index SERIAL PRIMARY KEY,
