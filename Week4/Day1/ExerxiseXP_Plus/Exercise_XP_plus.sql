...
-- add table columns with proper data types and NOT NULL restriction
...
-- nsert your last_name, first_name and birth_date to the students table (Take a look at the id given).
-- INSERT 
-- INTO students (id, first_name, last_name, birth_date)
