...
console.log(`The name of the 2nd tenant is ${building.nameOfTenants[1]} and the number of rooms he has in his apartment is ${building.numberOfRoomsAndRent.dan[0]}.\n`);

// Check if the sum of Sarah’s and David’s rent is bigger than Dan’s rent.If it is, than increase Dan’s rent to 1200.
sumOfRent = building.numberOfRoomsAndRent.sarah[1] + building.numberOfRoomsAndRent.david[1];

console.log(`Sum of Sarah's and David's rent is ${sumOfRent},\n while Dan's rent is ${building.numberOfRoomsAndRent.dan[1]}.\n`);
...
if (check === true) {
    ...
    console.log(`Since sum of rent of Sarah and David is${sumOfRent} is not bigger than Dan's rent, it was decided to keep Dan's rent at ${building.numberOfRoomsAndRent.dan[1]}.\n`);
}
