...
for (let i = 1; i <= 6; i++) {
    // Create a line of asterisks using string repetition and trim the trailing spaces
    const asterisksLine = "* ".repeat(i).trim();
...
for (let i = 0; i <= 5; i++) {
    ...
    asterisksLine += "*"; // Add the last asterisk without a trailing space
    console.log(asterisksLine);
}